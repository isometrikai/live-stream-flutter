...
void main() {
  final initialPlatform = AppscripLiveStreamComponentPlatform.instance;

  test('$MethodChannelAppscripLiveStreamComponent is the default instance', () {
    expect(initialPlatform,
        isInstanceOf<MethodChannelAppscripLiveStreamComponent>());
  });

  test('getPlatformVersion', () async {
    var appscripLiveStreamComponentPlugin = AppscripLiveStreamComponent();
    var fakePlatform = MockAppscripLiveStreamComponentPlatform();
