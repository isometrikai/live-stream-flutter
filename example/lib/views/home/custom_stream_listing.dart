            ...
            return SmartRefresher(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final isCreatedByMe = stream.userId == _streamService.currentUserId;

                  return _StreamListItem(
                    stream: stream,
                    isCreatedByMe: isCreatedByMe,
                    onTap: () => _streamService.joinStream(stream, isCreatedByMe),
                  );
                },
              ),
            );
                ...
                children: [
                  ...
                  Row(
                    children: [
                      CircleAvatar(
                        radius: 16,
                        backgroundImage: stream.userDetails?.userProfile != null
