...
class IsmLivePresignedUrl {
  ...
  factory IsmLivePresignedUrl.fromMap(Map<String, dynamic> map) =>
      IsmLivePresignedUrl(
  ...
  factory IsmLivePresignedUrl.fromJson(String source) =>
      IsmLivePresignedUrl.fromMap(json.decode(source) as Map<String, dynamic>);
