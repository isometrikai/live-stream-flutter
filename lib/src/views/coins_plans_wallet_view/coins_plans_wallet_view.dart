                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            Text(
                              '${controller.coinBalance.formatWithKAndL()} ${IsmLiveStrings.coins}',
                              style: IsmLiveStyles.blackBold16.copyWith(
                                color: textColor,
                              ),
                            ),
                        ...
                        Flexible(
                          child: IsmLiveButton(
                            label: IsmLiveStrings.transactions,
                            small: true,
                            onTap: () {
                              if (fromStream) {
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              '${_apiPlan.numberOfUnits} ${IsmLiveStrings.coins}',
