...
class IsmLiveMqttController extends GetxController {
  ...
  Future<void> setup({
    ...
    _mqttHelper.onConnectionChange((value) => IsmLiveApp.isMqttConnected = value);
      ...
      switch (action) {
        case IsmLiveActions.copublishRequestAccepted:
          ...
          if (memberId == userId || hostId == userId) {
            ...
            LocalNotificationService.showBasicNotification(body: message.body, title: 'Co-publishing request', payload: '');
        ...
        case IsmLiveActions.copublishRequestAdded:
          ...
          if (_streamController.isHost) {
            ...
            LocalNotificationService.showBasicNotification(body: message.body, title: 'Co-publishing requested', payload: '');
            unawaited(_streamController.handleMessage(message: message));
            _updateStream([IsmLiveControlsWidget.updateId]);
          }
          break;
        ...
        case IsmLiveActions.memberAdded:
          ...
          LocalNotificationService.showBasicNotification(body: message.body, title: 'Co-publishing added', payload: '');
        ...
        case IsmLiveActions.memberLeft:
          ...
          unawaited(_streamController.handleMessage(message: message));
          _streamController.streamMembersList.removeWhere((e) => e.userId == member.userId);
          _updateStream();
          break;
        ...
        case IsmLiveActions.messageSent:
          if (_streamController.streamId == streamId) {
            ...
            await _streamController.handleMessage(message: message, payload: payload);
