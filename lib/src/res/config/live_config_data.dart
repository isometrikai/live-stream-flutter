...
class IsmLiveConfigData with Diagnosticable {
  factory IsmLiveConfigData.fromMap(Map<String, dynamic> map) => IsmLiveConfigData(
        ...
        socketConfig: map['socketConfig'] != null ? IsmLiveWebSocketConfig.fromMap(map['socketConfig'] as Map<String, dynamic>) : null,
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty<IsmLiveWebSocketConfig>('socketConfig', socketConfig));
