...
class IsmLiveUtility {
  ...
  /// Prefer [tokenHeader]. Kept for callers that used the old name; secrets
  /// always come from [IsmLiveProjectConfig], never hardcoded in the SDK.
  static Map<String, String> newTokenHeader() => tokenHeader();
