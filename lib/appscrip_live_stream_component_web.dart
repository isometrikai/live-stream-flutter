...
class AppscripLiveStreamComponentWeb extends AppscripLiveStreamComponentPlatform {
  /// Constructs a AppscripLiveStreamComponentWeb
  AppscripLiveStreamComponentWeb();

  static void registerWith(Registrar registrar) {
    AppscripLiveStreamComponentPlatform.instance = AppscripLiveStreamComponentWeb();
  }
